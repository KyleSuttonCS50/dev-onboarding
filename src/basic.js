  ...
  render() {
    return (
      <div>
        ...
        <p className="body"> "Looks a little unrefined but has a heart of gold" -- Lauren Toman </p>
        <p className="body"> "If I was lost in the woods, he would either save me or murder me" -- Randle Steinbeck </p>
        <p className="body"> "Doesn't look as much like Post Malone as I expected" -- Caroline Graham </p>
