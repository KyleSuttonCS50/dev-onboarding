    ...
    return (
      <div>
        <NewModal
          ...
          desc=
            "What's For Dinner (or WhatsForDinner) is a simple webapp I built for my CS50 
        ...
        <NewModal
          ...
          desc=
            "My portfolio (the site you're using right now) is my first project with React.  It's a
